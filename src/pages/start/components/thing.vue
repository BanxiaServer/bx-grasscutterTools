<template>
  <div class="commuse">
    ...
    <div class="commuse-item">
      ...
      <a-cascader allow-search v-model="value3" :options="options2" placeholder="" filterable class="input" />
    </div>

    <div class="commuse-item">
      <div class="label">物品</div>
      <a-cascader allow-search v-model="value2" :options="options" placeholder="请输入物品" filterable class="input" />
    </div>

    <div class="commuse-item">
      <div class="label">数量</div>
      <a-input-number v-model="num" placeholder="请输入数量" mode="button" size="large" class="input" />
    </div>
    <div class="generate">
      <a-input v-model="value" placeholder="" class="input" />
